...
class Wegene:
    def __init__(self):
        self.baseurl='https://www.wegene.com/'
        self.login_url=''
        self.login_post='https://www.wegene.com/account/ajax/login_process/'
    ...
    def login(self):
        ...
        '''
        #存放cookie
        opener=self.saveCookieInFIle('/tmp/wegene.txt')
    ...
    def structure_headers(self):
        postData={
            "return_url":"https://www.wegene.com/",
            "user_name":"xxxxxx",
            "password":"xxxxxx",
            "net_auto_login":"1",
            "_post_type":"ajax"
        ...
        headers={
            ...
            "Referer":"https://www.wegene.com/account/login/",
